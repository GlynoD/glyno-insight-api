...
var encodedData = require('soop').load('glyno-core-js/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('glyno-core-js/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('glyno-core-js/lib/Address', {
